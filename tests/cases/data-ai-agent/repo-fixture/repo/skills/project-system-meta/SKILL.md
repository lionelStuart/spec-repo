...
description: Use inside this project-system managed Data AI Agent repository to operate repo/ as a closed-loop project memory system before coding rounds, task execution, write-back, handoff, archive decisions, or completion checks.
---
